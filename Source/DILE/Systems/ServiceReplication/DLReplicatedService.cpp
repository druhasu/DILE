...
#include "DLReplicatedService.h"

#include "Engine/NetDriver.h"
#include "Engine/Engine.h"

int32 DLReplicatedService_Private::GetFunctionCallspace(UObject* Service, UFunction* Function, FFrame* Stack)
{
...
bool DLReplicatedService_Private::CallRemoteFunction(UObject* Service, UFunction* Function, void* Parameters, FOutParmRec* OutParms, FFrame* Stack)
{
