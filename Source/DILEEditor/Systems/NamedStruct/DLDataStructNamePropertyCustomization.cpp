...
#include "DLDataStructNamePropertyCustomization.h"
...
void FDLDataStructNamePropertyCustomization::CustomizeHeader(TSharedRef<IPropertyHandle> InPropertyHandle, FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& CustomizationUtils)
{
...
void FDLDataStructNamePropertyCustomization::GetOptionNames(TArray<TSharedPtr<FString>>& OutStrings, TArray<TSharedPtr<SToolTip>>& OutToolTips, TArray<bool>& OutRestrictedItems) const
{
...
FString FDLDataStructNamePropertyCustomization::GetCurrentValue() const
{
    FString Value;
...
void FDLDataStructNamePropertyCustomization::SetNewValue(const FString& InValue)
{
